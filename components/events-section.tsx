...
export function EventsSection() {
  const [events, setEvents] = useState<Event[]>([
    {
      ...
      date: "February 6",
      time: "9:00 PM",
      description: "Experience the ultimate weekend starter with live DJ sets, premium cocktails, and an electric atmosphere.",
      image: "lounge1.webp",
      category: "Nightlife",
      ticket_url: "https://www.sevenrooms.com/reservations/gdlounge"
    },
    {
      id: "evt-2",
      title: "Friday Night Vibes",
  ...
  // useEffect(() => {
  //   // Supabase fetch commented out for manual override requested by user
  // }, []);
