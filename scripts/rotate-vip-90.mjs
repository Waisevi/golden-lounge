...
async function processImage() {
    try {
        ...
        console.log('📸 Поворачиваю изображение VIP Room еще на +90°...');
        ...
        console.log('🔄 Поворачиваю на +90° по часовой стрелке...');
        ...
        while (attempts < maxAttempts) {
            ...
            await sharp(inputPath)
                .rotate(90) // Поворот на +90° по часовой стрелке
                .resize(width, height, { 
                    fit: 'inside',
        ...
        console.log(`\n✨ Готово! Изображение повернуто еще на +90°.`);
