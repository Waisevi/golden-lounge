...
export function MediaCarousel({
    ...
    // For now simple implementation: if slide 0 is video, it auto-plays muted.
                            ...
                            {item.type === "video" ? (
                                <>
                                    <video
                                        ...
                                        poster={item.poster ? getAssetUrl(item.poster) : undefined}
                                    ...
                                    <div className="absolute bottom-6 right-6 flex items-center gap-3 z-20">
                                        ...
                                        {/* Optional Play/Pause - usually autoplay loop is preferred for ambience, but good to have control */}
                                        {/* <button 
                        onClick={togglePlay}
                        className="w-10 h-10 rounded-full bg-black/40 backdrop-blur-md border border-white/20 flex items-center justify-center text-white hover:bg-black/60 transition-all"
                    >
